...
namespace DapperRepository.Drapper.Sql
{
    public class SqlGenerator : ISqlGenerator
    {
        ...
        public virtual string Create(IClassMapper classMap)
        {
            return string.Empty;
        }

        public virtual string Exists(IClassMapper classMap)
        {
            if (classMap == null)
        ...
        public virtual string Drop(IClassMapper classMap)
        {
            ...
            return String.Format("DROP TABLE {0}", GetTableName(classMap));
        }
