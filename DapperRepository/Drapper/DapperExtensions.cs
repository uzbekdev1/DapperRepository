...
namespace DapperRepository.Drapper
{
    public static class DapperExtensions
    {
        ...
        public static void Create<T>(this IDbConnection connection, int? commandTimeout = null) where T : class
        {
            Instance.Create<T>(connection, commandTimeout);
        }

        public static void Drop<T>(this IDbConnection connection, int? commandTimeout = null) where T : class
        {
            Instance.Drop<T>(connection, commandTimeout);
        }

        public static bool Exists<T>(this IDbConnection connection, int? commandTimeout = null) where T : class
        {
            return Instance.Exists<T>(connection, commandTimeout);
        }
