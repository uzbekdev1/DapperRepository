...
namespace DapperRepository.Drapper
{
    public interface IDapperImplementor
    {
        ...
        void CreateSchemaIfNotExists<T>(IDbConnection connection, int? commandTimeout) where T : class;
        void CreateDatabaseIfNotExists(IDbConnection connection,string connectionString, int? commandTimeout);
