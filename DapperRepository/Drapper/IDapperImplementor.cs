...
namespace DapperRepository.Drapper
{
    public interface IDapperImplementor
    {
        ...
        bool Exists<T>(IDbConnection connection, int? commandTimeout) where T : class;
        void Create<T>(IDbConnection connection, int? commandTimeout) where T : class;
        void Drop<T>(IDbConnection connection, int? commandTimeout) where T : class;
